...
var overDraftProtection = function(){
  var savingsAccBalance = balanceSavings();
  var checkingAccBalance = balanceCheck();
...
$('#checking-withdraw').on('click', function(){
  ...
  var checkingsBal = balanceCheck();
  var checkingWithdrawAmount = +$('#checking-amount').val();
  if((checkingsBal >= checkingWithdrawAmount)){
    checkingsBal = checkingsBal - checkingWithdrawAmount;
    $('#checking-balance').text('$'+checkingsBal);
    if(checkingsBal===0){
